...
if ((!empty($_POST['name'])) && (!empty($_POST['contact'])) && (!empty($_POST['specialization']))) {
	$token='6204533739:AAHBFkdmWOtJmR_BZZL7LMBxHsomj31A9Cg';
	$chat_id='-4021700543'; 

	$text = '🙋‍♂️Новая заявка на сайте ВР ИТ (вакансии):';
	$name = 'ФИО: '.$_POST['name'];
	$contacts = 'Контакты: '.$_POST['contact'];
	$description = 'Кем хочет быть: '.$_POST['specialization'];
